...
var AdviserComponent = /** @class */ (function () {
    function AdviserComponent(adviserService, modalService) {
    ...
    AdviserComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.adviserService.get().subscribe(function (response) { return _this.advisors = response; });
    };
    AdviserComponent.prototype.open = function (content, adviser) {
        var _this = this;
        this.padviser = adviser;
        this.modalService.open(content, { size: 'lg' }).result.then(function (result) {
            if (result == "update") {
                _this.update(_this.padviser);
            }
            if (result == "delete") {
                _this.delete(_this.padviser.id);
            }
        }, function (reason) {
            sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire('Mensaje', "Dismissed " + _this.getDismissReason(reason), 'info');
        });
    };
    AdviserComponent.prototype.getDismissReason = function (reason) {
    ...
    AdviserComponent.prototype.create = function () {
        var _this = this;
        this.adviserService.create(this.cadviser).subscribe(function (res) {
            _this.cadviser = res;
            _this.ngOnInit();
            sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire('Mensaje', "Se ha creado el asesor", 'success');
        }, function (err) { return sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire('Error', err.error.mensaje, 'error'); });
    };
    AdviserComponent.prototype.update = function (adviser) {
        var _this = this;
        this.adviserService.update(adviser).subscribe(function (res) {
            _this.padviser = res;
            _this.ngOnInit();
            sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire('Mensaje', "Se ha actualizado el asesor", 'success');
        }, function (err) { return sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire('Error', err.error.mensaje, 'error'); });
    };
    AdviserComponent.prototype.delete = function (id) {
        var _this = this;
        this.adviserService.delete(id).subscribe(function (res) {
            _this.bandera = res;
            _this.ngOnInit();
            sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire('Mensaje', "Se ha eliminado el asesor", 'success');
        }, function (err) { return sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire('Error', err.error.mensaje, 'error'); });
    };
    AdviserComponent.ctorParameters = function () { return [
...
var AdviserService = /** @class */ (function () {
    function AdviserService(http, router) {
        this.http = http;
        this.router = router;
        this.headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' });
        this.options = { headers: this.headers };
    }
    AdviserService.prototype.create = function (adviser) {
        return this.http.post(_global__WEBPACK_IMPORTED_MODULE_6__["endpoint"] + '/adviser', JSON.stringify(adviser), this.options).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) { return response; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["throwError"])(err);
        }));
    };
    AdviserService.prototype.get = function () {
        return this.http.get(_global__WEBPACK_IMPORTED_MODULE_6__["endpoint"] + '/adviser').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) { return response; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["throwError"])(err);
        }));
    };
    AdviserService.prototype.getID = function (id) {
        return this.http.get(_global__WEBPACK_IMPORTED_MODULE_6__["endpoint"] + '/adviser' + '/' + id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) { return response; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["throwError"])(err);
        }));
    };
    AdviserService.prototype.update = function (adviser) {
        return this.http.put(_global__WEBPACK_IMPORTED_MODULE_6__["endpoint"] + '/adviser', JSON.stringify(adviser), this.options).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) { return response; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["throwError"])(err);
        }));
    };
    AdviserService.prototype.delete = function (id) {
        return this.http.delete(_global__WEBPACK_IMPORTED_MODULE_6__["endpoint"] + '/adviser' + '/' + id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) { return response; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["throwError"])(err);
        }));
    };
    AdviserService.ctorParameters = function () { return [
...
var CardService = /** @class */ (function () {
    function CardService(http, router) {
        this.http = http;
        this.router = router;
        this.headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' });
        this.options = { headers: this.headers };
    }
    CardService.prototype.getHistorys = function (id) {
        return this.http.get(_global__WEBPACK_IMPORTED_MODULE_6__["endpoint"] + '/' + id + '/historys').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) { return response; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["throwError"])(err);
        }));
    };
...
var CustomerComponent = /** @class */ (function () {
    ...
    CustomerComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.customerService.get().subscribe(function (response) { return _this.customers = response; });
    };
    CustomerComponent.prototype.open = function (content, customer) {
        var _this = this;
        this.pcustomer = customer;
        this.modalService.open(content, { size: 'lg' }).result.then(function (result) {
            if (result == "update") {
                _this.update(_this.pcustomer);
            }
            if (result == "delete") {
                _this.delete(_this.pcustomer.id);
            }
        }, function (reason) {
            sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire('Mensaje', "Dismissed " + _this.getDismissReason(reason), 'info');
        });
    ...
    CustomerComponent.prototype.create = function () {
        var _this = this;
        this.customerService.create(this.ccustomer).subscribe(function (res) {
            _this.ccustomer = res;
            _this.ngOnInit();
            sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire('Mensaje', "Se ha creado el cliente", 'success');
        }, function (err) { return sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire('Error', err.error.mensaje, 'error'); });
    };
    CustomerComponent.prototype.update = function (customer) {
        var _this = this;
        this.customerService.update(customer).subscribe(function (res) {
            _this.pcustomer = res;
            _this.ngOnInit();
    ...
    CustomerComponent.prototype.delete = function (id) {
        var _this = this;
        this.customerService.delete(id).subscribe(function (res) {
            _this.bandera = res;
            _this.ngOnInit();
...
var CustomerService = /** @class */ (function () {
    ...
    CustomerService.prototype.create = function (customer) {
        return this.http.post(_global__WEBPACK_IMPORTED_MODULE_6__["endpoint"] + '/customer', JSON.stringify(customer), this.options).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) { return response; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["throwError"])(err);
        }));
    };
    CustomerService.prototype.get = function () {
        return this.http.get(_global__WEBPACK_IMPORTED_MODULE_6__["endpoint"] + '/customer').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) { return response; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["throwError"])(err);
        }));
    };
    CustomerService.prototype.getID = function (id) {
        return this.http.get(_global__WEBPACK_IMPORTED_MODULE_6__["endpoint"] + '/customer' + '/' + id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) { return response; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["throwError"])(err);
        }));
    };
    CustomerService.prototype.getCards = function (id) {
        return this.http.get(_global__WEBPACK_IMPORTED_MODULE_6__["endpoint"] + '/customer' + '/' + id + '/cards').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) { return response; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["throwError"])(err);
        }));
    };
    CustomerService.prototype.update = function (customer) {
        return this.http.put(_global__WEBPACK_IMPORTED_MODULE_6__["endpoint"] + '/customer', JSON.stringify(customer), this.options).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) { return response; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["throwError"])(err);
        }));
    };
    CustomerService.prototype.delete = function (id) {
        return this.http.delete(_global__WEBPACK_IMPORTED_MODULE_6__["endpoint"] + '/customer' + '/' + id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) { return response; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["throwError"])(err);
        }));
    };
...
var endpoint = 'https://backendibm-proud-okapi.mybluemix.net/ibm';
...
var HistoryComponent = /** @class */ (function () {
    function HistoryComponent(customerService, cardService, modalService) {
        this.customerService = customerService;
    ...
    HistoryComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.customerService.get().subscribe(function (response) {
            _this.customers = response;
            console.log(_this.customers);
        });
    };
    HistoryComponent.prototype.select = function (id) {
        var _this = this;
        this.customerService.getCards(id).subscribe(function (response) {
            _this.scustomer = response;
        });
    };
    HistoryComponent.prototype.open = function (content, card) {
        var _this = this;
        this.cardService.getHistorys(card.id).subscribe(function (response) {
            _this.card = response;
            console.log(_this.card);
        });
        this.modalService.open(content, { size: 'lg' }).result.then(function (result) {
        }, function (reason) {
            sweetalert2__WEBPACK_IMPORTED_MODULE_6___default.a.fire('Mensaje', "Dismissed " + _this.getDismissReason(reason), 'info');
        });
    };
